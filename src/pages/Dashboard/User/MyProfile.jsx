...
const MyProfile = () => {
    ...
    return (
        <div className="flex flex-col mx-auto max-w-lg justify-center p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
            <img src={user.photoURL} alt="profile" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square object-cover" />
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h2 className="text-lg font-semibold sm:text-xl">Subdistrict: {users.upazila}</h2>
                </div>
            </div>
