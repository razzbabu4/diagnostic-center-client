    ...
    return (
        <div className="card card-compact w-full bg-base-100 shadow-2xl">
            <div className="relative">
                ...
                <div className="absolute text-white bg-black font-medium p-3 rounded-tl-xl bg-opacity-60 bottom-0 right-0 flex items-center gap-2">
                    <FaDollarSign/> {test.price}
                </div>
            </div>
            <div className="card-body">
                <h2 className="card-title">{test.name}</h2>
                <span className="font-bold text-gray-400 flex-grow">{test.details}</span>
